...
### The following script was modified by Alex Koiter
### This script over rides the plotting functions within the MixSIAR package. It allows for the compile notebook feature in RStudio to be used all I have done is remove the dev.new() function (graphics in new windows). Since I use this model for applications with no isotopes I have also removed the functions that rename the axis labels as it would think my selenium (Se) tracers was an isotope of sulpher (S)
source("mixSIAR_plot_override.R") 
################################################################################
